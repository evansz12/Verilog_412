...
void CanBus0_Transmit(void)
{
    ...
    Can0_TxBuffer3   = 0x51;     //data 1
    Can0_TxBuffer4   = 0x76;     //data 1
    Can0_TxBuffer5   = 0x61;     //data 1
    Can0_TxBuffer6   = 0x6E;     //data 1
    Can0_TxBuffer7   = 0x45;     //data 1
    Can0_TxBuffer8   = 0x76;     //data 1
    Can0_TxBuffer9   = 0x61;     //data 1
    Can0_TxBuffer10  = 0x58;     //data 8
    //Can0_TxBuffer11  = 0x00;
    //Can0_TxBuffer12  = 0x00;
...
void CanBus1_Transmit(void)
{
    ...
    Can1_TxBuffer1   = 0x00;     /* ID1   = A4, (1010 0100)                         */
    Can1_TxBuffer2   = 0x00;     /* ID2   = 20, (0010 0000)                         */
    Can1_TxBuffer3   = 0x51;     //data 1
    Can1_TxBuffer4   = 0x76;     //data 1
    Can1_TxBuffer5   = 0x61;     //data 1
    Can1_TxBuffer6   = 0x6E;     //data 1
    Can1_TxBuffer7   = 0x45;     //data 1
    Can1_TxBuffer8   = 0x76;     //data 1
    Can1_TxBuffer9   = 0x61;     //data 1
    Can1_TxBuffer10  = 0x58;     //data 8
    Can1_TxBuffer11  = 0x58;
    Can1_TxBuffer12  = 0x58;
...
void CanBus0_Receive(void)
{
    ...
    do {
        printf(":%x", Can0_StatusReg);
    } while ((Can0_StatusReg & RBS_Bit  ) != RBS_Bit  );
    if  ((Can0_StatusReg & RBS_Bit  ) == RBS_Bit  ) {
        frameId[0] = Can0_RxBuffer1;
        frameId[1] = Can0_RxBuffer2;
        frameId[2] = Can0_RxFrameInfo;
        printf("\nFrame: %s", frameId[2]);
        data[0] = Can0_RxBuffer3;
        data[1] = Can0_RxBuffer4;
        data[2] = Can0_RxBuffer5;
        data[3] = Can0_RxBuffer6;
        data[4] = Can0_RxBuffer7;
        data[5] = Can0_RxBuffer8;
        data[6] = Can0_RxBuffer9;
        data[7] = Can0_RxBuffer10;
...
void CanBus1_Receive(void)
{
    ...
    do {
        /* start a polling timer and run some tasks while waiting
        break the loop and signal an error if time too long                    */
        printf(":%x", Can1_StatusReg);
    } while((Can1_StatusReg & RBS_Bit  ) != RBS_Bit  );
    printf("\nTr1: %x", Can1_StatusReg);
